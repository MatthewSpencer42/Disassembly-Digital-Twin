...
def launch_setup(context, *_args, **_kwargs):
    ...
    controller_spawners = [
        ...
        Node(package="controller_manager", executable="spawner", arguments=["xarm_gripper_controller", *controller_manager_args], output="screen"),
        Node(package="controller_manager", executable="spawner", arguments=["slider_controller", *controller_manager_args], output="screen"),
    ]

    cleanup_patterns = [
        "nr_dual_arm_moveit_config/launch/demo.launch.py",
        "nr_dual_arm_moveit_config/launch/exotica.launch.py",
        "nr_dual_arm_moveit_config/hardware/real_hardware.py",
        "lib/nr_dual_arm_moveit_config/real_hardware.py",
        "nr_dual_arm_moveit_config/hardware/joint_state_filter.py",
        "lib/nr_dual_arm_moveit_config/joint_state_filter.py",
        "nr_dual_arm_moveit_config/hardware/isaac_state_relay.py",
        "lib/nr_dual_arm_moveit_config/isaac_state_relay.py",
        "nr_dual_arm_moveit_config/hardware/teleop_bridge.py",
        "lib/nr_dual_arm_moveit_config/teleop_bridge.py",
        "nr_dual_arm_moveit_config/nr_dual_arm_moveit_config/exotica_ik_server_node.py",
        "lib/nr_dual_arm_moveit_config/exotica_ik_server_node.py",
...
def generate_launch_description():
    ...
    moveit_pkg_share = Path(get_package_share_directory("nr_dual_arm_moveit_config"))
