...
def launch_setup(context, *_args, **_kwargs):
    ...
    cleanup_patterns = [
        ...
        "lib/dual_arm_moveit_config/real_hardware.py",
        "dual_arm_moveit_config/hardware/joint_state_filter.py",
        "lib/dual_arm_moveit_config/joint_state_filter.py",
        "dual_arm_moveit_config/hardware/isaac_state_relay.py",
        "lib/dual_arm_moveit_config/isaac_state_relay.py",
        "dual_arm_moveit_config/hardware/teleop_bridge.py",
        "lib/dual_arm_moveit_config/teleop_bridge.py",
        "dual_arm_moveit_config/dual_arm_moveit_config/exotica_ik_server_node.py",
        "lib/dual_arm_moveit_config/exotica_ik_server_node.py",
