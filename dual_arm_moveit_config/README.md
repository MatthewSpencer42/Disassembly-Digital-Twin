...
ros2 launch dual_arm_moveit_config exotica.launch.py hardware_type:=real
```
...
Implemented in [teleop_bridge.py](/home/adip/workspace/disassembly_ws/src/agentic_disassembly/dual_arm_moveit_config/hardware/teleop_bridge.py):
...
- [xarm_servo.yaml](/home/adip/workspace/disassembly_ws/src/agentic_disassembly/dual_arm_moveit_config/config/xarm_servo.yaml)
- [uf_servo.yaml](/home/adip/workspace/disassembly_ws/src/agentic_disassembly/dual_arm_moveit_config/config/uf_servo.yaml)
...
- [realsense_handeye.calib](/home/adip/workspace/disassembly_ws/src/agentic_disassembly/dual_arm_moveit_config/config/realsense_handeye.calib)
